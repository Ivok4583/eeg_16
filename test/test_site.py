...
def test_two_monitors(browser):
    ...
    # monitor_link.click()
    time.sleep(2)#так делать НЕЛЬЗЯ!!!, НИКОГДА!!!, ожидания должны быть - чего-то конкретного(потемнения кнопки, смены URL и т.д. Просто отсески времени не должно быть
